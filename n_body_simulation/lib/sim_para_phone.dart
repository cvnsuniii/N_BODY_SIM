...
class Sim_para_phone extends StatefulWidget {
  const Sim_para_phone({super.key,required this.user, required this.title, required this.coordinates,required this.data});
  final String user;
  final String title;
  ...
  @override
  State<Sim_para_phone> createState() => Simparastatephone();
}
class Simparastatephone extends State<Sim_para_phone> {
      ...
      setStatebody){
        return Column(spacing:10,
          children:[
            ...
            Row(spacing:15,children:[
              if (editbody) Text("edit below ",style:TextStyle(fontSize:18)),
            ...
            Row(textDirection:TextDirection.rtl,spacing:15,children:[
              if (editbody && errorbody) Icon(Icons.info_outlined),
              if (errorbody && editbody) Expanded(child:Text("body name cant be duplicate or empty")), 
            ]),
            ...
            Row(textDirection:TextDirection.rtl,spacing:15,children:[
              if (errorm) Icon(Icons.error,color:Colors.red),
              if (errorm) Expanded(child:Text("only positive numbers can be used and not empty",style:TextStyle(fontSize:15))),
            ]),
            ...
            Row(textDirection:TextDirection.rtl,spacing:15,children:[
              ...
              if (errorpx) Expanded(child:Text("only real numbers can be used and not empty",style:TextStyle(fontSize:15))),
            ]),
            Row(spacing:15,children:[
            ...
            Row(textDirection:TextDirection.rtl,spacing:15,children:[
              ...
              if (errorpy) Expanded(child:Text("only real numbers can be used and not empty",style:TextStyle(fontSize:15))),
            ]),
            Row(spacing:15,children:[
            ...
            Row(textDirection:TextDirection.rtl,spacing:15,children:[
              ...
              if (errorpz) Expanded(child:Text("only real numbers can be used and not empty",style:TextStyle(fontSize:15))),
            ]),
            Row(spacing:15,children:[
              SizedBox(width: 180,child:Text("Color ",style:TextStyle(fontSize:15))),
              //Text(nowcolor(),style:TextStyle(fontSize:18)),
              //Text(nowcolor(),style:TextStyle(fontSize:18)),
              MenuAnchor(
                builder:(BuildContext context, MenuController controller, Widget? child) {return TextButton(onPressed:(){if (controller.isOpen){controller.close();} else{controller.open();}},child: Text("",style:TextStyle(fontSize: 15)),);},// fucking check the fucking error here 
            ...
            Row(textDirection:TextDirection.rtl,spacing:15,children:[
              ...
              if (errorr) Expanded(child:Text("only positive(or 0) numbers can be used and not empty",style:TextStyle(fontSize:15))),
            ]),
            ...
            Row(textDirection:TextDirection.rtl,spacing:15,children:[
              ...
              if (errorvx) Expanded(child:Text("only real numbers can be used and not empty",style:TextStyle(fontSize:15))),
            ]),
            Row(spacing:15,children:[
            ...
            Row(textDirection:TextDirection.rtl,spacing:15,children:[
              ...
              if (errorvy) Expanded(child:Text("only real numbers can be used and not empty",style:TextStyle(fontSize:15))),
            ]),
            Row(spacing:15,children:[
            ...
            Row(textDirection:TextDirection.rtl,children: [
              Expanded(child:Text("please note that the initial accelerations are 0, which means no external forces.",style:TextStyle(fontSize:15)))
            ],),
            SizedBox(height:40)
          ]
        );
  ...
  Widget simspeed(BuildContext context){
    ...
    return Row(spacing:20,children: [
      Text("Sim speed",style:TextStyle(fontSize:15)),
                  ...
                  child:SingleChildScrollView(
                    child:Container(
                      ...
                      child:Column(spacing:10,children: [  
                        Row(spacing:15,children: [
                          if (!titledit)Text(simtitle,style:TextStyle(fontSize:20,color:Colors.black)),
                          if(!titledit) IconButton(icon:Icon(Icons.edit),onPressed:(){titledit=!titledit;setState((){});}),                                                                            
                        ],),
                        Row(spacing:15,children:[
                          if (titledit) Text("Enter title below",style:TextStyle(fontSize:20,color:Colors.black)),
                        ...
                        Row(textDirection:TextDirection.rtl,spacing:15,children:[
                          ...
                          if(titledit) Expanded(child:Text("press enter to change",style:TextStyle(fontSize: 15)))
                        ]),
                        Row(spacing:15,children:[
                          if (titledit &&errortitle) Icon(Icons.error,color:Colors.red),
                          if (titledit &&errortitle) Text("you already used this") ,
                          if (titledit &&errortitle) Text("title cannot be empty") ,  
                        ]),
                        SizedBox(height:20),
                        Text("No of Bodies",style:TextStyle(color:Colors.black,fontSize:18)),
                        SizedBox(
                          width:200,
                          child:TextField(
                        ...
                        Row(textDirection:TextDirection.rtl,spacing:20,children: [                        
                          if (valNoBody==1||valNoBody==2) Icon(Icons.dangerous,color:Colors.red),
                          if (valNoBody==1) Expanded(child:Text("invalid number type.please enter a integer",style:TextStyle(color:Colors.black,fontSize:14))),
                          if(valNoBody==2) Expanded(child:Text("Input cant be negative and less than 2",style:TextStyle(color:Colors.black,fontSize:14))),
                        ],),
                        Row(textDirection:TextDirection.rtl,spacing:15,children:[Icon(Icons.info_outlined,size:15),Expanded(child:Text("Press Enter to validate the number of bodies.note that using this feature discards all previous bodies and creates a new list of bodies with this number"))]),
                        SizedBox(height:20),
                        Row(textDirection:TextDirection.rtl,spacing:15,children: [Icon(Icons.info_outlined,size:20),Expanded(child:Text("please press enter to make changes in every text field.",style:TextStyle(backgroundColor:Colors.amber)))],),
                        ...
                        Row(spacing:50,children:[
                          Tooltip(message:"advised to choose according to your computer capabilities",child:Text("Frame",style:TextStyle(fontSize:15))),
                          MenuAnchor(
                            builder:(BuildContext context,MenuController controller,Widget? child) {
                              return TextButton(onPressed: (){if(controller.isOpen){controller.close();} else{controller.open();}},child:Text("$timestep ms",style:TextStyle(fontSize:15)));
                            },
                            menuChildren: [for(int k=0; k<frame.length; k++) ListTile(selectedColor:Colors.lime,focusColor:Colors.grey,onTap:(){timestep=frame[k];setState((){});},title:Text(frame[k].toString(),style:TextStyle(fontSize:15)))],
                          ),
                        ]),                      
                        SizedBox(height:10),
                        simspeed( context),
                        SizedBox(height: 10,),
                        Text("Total time of sim(s)-",style:TextStyle(fontSize:15)),
                        simtime(context),
                          ...
                          SizedBox(width:150,height:40,child:FloatingActionButton(heroTag:null,backgroundColor:Colors.green,child:Text("check & Save",style:TextStyle(color: Colors.white)),onPressed:(){
                            ...
                            showDialog(context:context,builder:(BuildContext context) {
                              ...
                              return AlertDialog(
                                ...
                                content:Text("A total of $nt calculations will be done. please check if your computer is RAM capable.Also note that this is a phone and will only make the simdata and wont display.",style:TextStyle(fontSize:18)),
