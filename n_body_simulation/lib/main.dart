...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future func2(BuildContext context ,index, data){return showDialog<Map> (
    context:context,
    builder:(context){return KeyboardListener(focusNode:FocusNode(),onKeyEvent:(KeyEvent x){if (x.physicalKey==PhysicalKeyboardKey.enter) Navigator.of(context).pop();},child:AlertDialog(
      contentPadding:EdgeInsets.all(20),
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) => ListTile(
                                  ...
                                  onTap: () async{
                                    await Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (context) => Sim_para_phone(
                                          user:user,
                                          title: keys[index].toString(),
                                          coordinates: values[index],
                                          data:data
          ...
          return Scaffold(
            ...
            body: Center(
              child: Container(
                width: double.infinity,
                height: MediaQuery.of(context).size.height,
                padding: EdgeInsets.only(left:80,right:80,top:50,bottom:50),
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.fill,
                    image: AssetImage("assets/images/background_main.png"),
